...
const PaymentStatus = () => {
    ...
    return <div className="payment-status">
                <div className="payment-status__body">
                   {status? <>
                        <FcInfo style={{fontSize:"4rem", marginBottom:"2rem", backgroundColor:"rgb(246, 107, 26);"}} />
                        <div className="payment-success">Payment of N500 was successful! </div>
                    </>:
                    <>
                        <BsExclamationTriangleFill style={{fontSize:"4rem", marginBottom:"2rem", color:"rgb(246, 107, 26);"}} />
