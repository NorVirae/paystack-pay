    ...
    return <div className="login"> 
            ...
            <form className="login__form">
                <fieldset className="form-group">
                    <input onChange={e=>} type={"text"} value={values.username} onFocus={e=>setFocus({...forcus,username:true })} className={cx("form-control",{"login-focus":forcus.username || values.username != ""})} />
