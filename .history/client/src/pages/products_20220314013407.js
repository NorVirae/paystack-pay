                    ...
                    <div className="product__description">
                        ...
                        <form onSubmit={handleBuy}>
                            ...
                            <div className="product__detail">
                                ...
                                <input value={values.} onChange={e=>setValues({...values, email:e.target.value})} required type={"email"} className="form-control-product"/>
                            ...
                            <div className="product__detail">
                                <div className="product__detail--title">name</div>
                                <input onChange={e=>setValues({...values, name:e.target.value})} required type={"text"} className="form-control-product"/>
                            ...
                            <div className="product__detail">
                                ...
                                <input onChange={e=>setValues({...values, phone:e.target.value})} required type={"number"} className="form-control-product"/>
