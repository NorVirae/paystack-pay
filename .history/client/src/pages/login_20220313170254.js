...
const Login = () =>  {
    ...
    return <div className="login"> 
            ...
            <form autoComplete="" className="login__form">
                <fieldset className="form-group">
                    <input autoComplete={false} onChange={e=>setValues({...values, username:e.target.value})} type={"text"} value={values.username} onFocus={e=>setFocus({...forcus,username:true })} className={cx("form-control",{"login-focus":forcus.username || values.username != ""})} />
